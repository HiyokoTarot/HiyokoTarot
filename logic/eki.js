    const hexagrams = [
      ...
      { number: 3, name: "☵☳水雷屯（すいらいちゅん）", emoji: "💧⚡", keyword: "生みの苦しみ・始動・混沌", lines: [1,0,0,0,1,0], message: "始まりには混乱がつきもの。すぐに形にならなくても、芽は出てきているよ。<br>今は準備期間。仲間が助けてくれるかも", image: "./eki/03SuiRaichun.png" },

      { number: 4, name: "☶☵山水蒙（さんすいもう）", emoji: "⛰️💧", keyword: "学び・未熟・問い直し", lines: [0,1,0,0,0,1], message: "わからないことを恥じなくて大丈夫。今日は学ぶ姿勢が運を開きます。素直に聞くことが鍵。", image: "./eki/04SanSuimo.png" },
      ...
      { number: 13, name: "☰☲天火同人（てんかどうじん）", emoji: "☁️🔥", keyword: "同志・仲間・開かれた協力", lines: [1,0,1,1,1,1], message: "同じ志を持つ人との縁が力になります。ひとりの正解より、共に進む道を探して。", image: "./eki/13TenKadojin.png" },

      { number: 14, name: "☲☰火天大有（かてんたいゆう）", emoji: "🔥☁️", keyword: "豊かさ・実力、分かち合い", lines: [1,1,1,1,0,1], message: "キミは今、たくさんの力や資源を持っているから、自然と人や幸運が集まってくるんだよ<br>独り占めしないで、みんなで分け合おう", image: "./eki/14KaTentaiyu.png" },

      { number: 15, name: "☷☶地山謙（ちざんけん）", emoji: "🌱⛰️", keyword: "謙虚・調整・控えめな強さ、土台", lines: [0,0,1,0,0,0], message: "謙虚に足元を見つめ、力を蓄える時期<br>おごらずに進めば、積み重ねが大きな力になるよ", image: "./eki/15ChiZanken.png" },

      { number: 16, name: "☳☷雷地豫（らいちよ）", emoji: "⚡🌱", keyword: "喜び・準備・勢いづけ", lines: [0,0,0,1,0,0], message: "十分な準備ができたね<br>仲間と力を合せて、この追い風に乗ろう！<br>でも、調子に乗り過ぎないこと", image: "./eki/16RaiChiyo.png" },

      { number: 17, name: "☱☳沢雷随（たくらいずい）", emoji: "🫧⚡", keyword: "従う・流れに乗る・柔軟", lines: [1,0,0,1,1,0], message: "今日は流れに合わせる柔軟さが大切。自分のこだわりを少しゆるめると、道が開けます。", image: "./eki/17TakuRaizui.png" },

      { number: 18, name: "☶☴山風蠱（さんぷうこ）", emoji: "⛰️🍃", keyword: "立て直し・修復・古い問題", lines: [0,1,1,0,0,1], message: "見ないふりをしてきたことを整えて蘇らせる時。壊すためではなく、再生するための見直しです。", image: "./eki/18SanPuko.png" },

      { number: 19, name: "☷☱地沢臨（ちたくりん）", emoji: "🌱🫧", keyword: "近づく・見守る・成長", lines: [1,1,0,0,0,0], message: "良い流れが近づいています。上から押さえるより、あたたかく見守る姿勢が実りを呼びます。", image: "./eki/19ChiTakurin.png" },

      { number: 20, name: "☴☷風地観（ふうちかん）", emoji: "🍃🌱", keyword: "観察・見極め・俯瞰", lines: [0,0,0,0,1,1], message: "今日は動くより観る日。一度立ち止まって、周囲や自分の状態を少し高い視点から眺めると、本当に大切なものが見えてきます。", image: "./eki/20FuChikan.png" },
      ...
      { number: 27, name: "☶☳山雷頤（さんらいい）", emoji: "⛰️⚡", keyword: "養う・言葉・食べるもの", lines: [1,0,0,0,0,1], message: "何を取り入れるかが大切な日。食べ物、言葉、情報。あなたを養うものを選んで。", image: "./eki/27SanRaii.png" },

      { number: 28, name: "☱☴沢風大過（たくふうたいか）", emoji: "🫧🍃", keyword: "重荷・限界・大きな決断", lines: [0,1,1,1,1,0], message: "抱えすぎに注意。強く見えても梁はしなるもの。助けを借りる、減らす、決めることが必要です。", image: "./eki/28TakuFutaika.png" },

      { number: 29, name: "☵☵坎為水（かんいすい）", emoji: "💧💧", keyword: "危険・深み・慎重", lines: [0,1,0,0,1,0], message: "足元が見えにくい時。怖さを否定せず、慎重に進めば深い学びに変わります。", image: "./eki/29KaniSui.png" },

      { number: 30, name: "☲☲離為火（りいか）", emoji: "🔥🔥", keyword: "明晰・情熱・照らす", lines: [1,0,1,1,0,1], message: "心に火が灯る日。感情に焼かれず、光として使うことで周りも照らせます。", image: "./eki/30RiiKa.png" },
      ...
      { number: 34, name: "☳☰雷天大壮（らいてんたいそう）", emoji: "⚡☁️", keyword: "強い力・勢い・自制", lines: [1,1,1,1,0,0], message: "勢いがあります。ただし力が強い時ほど慎重に。正しい方向へ使えば大きく進めます。", image: "./eki/34KaChishin.png" },

      { number: 35, name: "☲☷火地晋（かちしん）", emoji: "🔥🌱", keyword: "前進・昇る・認められる", lines: [0,0,0,1,0,1], message: "少しずつ光の方へ進んでいます。小さな成果を受け取り、自信に変えていきましょう。", image: "./eki/00Keniten.png" },
      ...
      { number: 40, name: "☳☵雷水解（らいすいかい）", emoji: "⚡💧", keyword: "解放・ほどける・雪解け・チャンス", lines: [0,1,0,1,0,0], message: "雪が解けて、水が一気に流れ出したよ<br>止まっていた問題が解決する、このタイミングを逃さないで", image: "./eki/40RaiSuikai.png" },

      { number: 41, name: "☶☱山沢損（さんたくそん）", emoji: "⛰️🫧", keyword: "減らす・手放す・本質", lines: [1,1,0,0,0,1], message: "減らすことで整う日。予定、荷物、思い込み。余白を作ると本当に大事なものが残ります。", image: "./eki/41SanTakuson.png" },

      { number: 42, name: "☴☳風雷益（ふうらいえき）", emoji: "🍃⚡", keyword: "増える・助け・成長", lines: [1,0,0,0,1,1], message: "良い助けや成長の流れがあります。受け取ったものは、また誰かへ渡すとさらに巡ります。", image: "./eki/42FuRaieki.png" },
      ...
      { number: 49, name: "☱☲沢火革（たくかかく）", emoji: "🫧🔥", keyword: "改革・変化・刷新・古い殻を脱ぐ・方向転換", lines: [1,0,1,1,1,0], message: "古い服は脱ぎ捨てて、新しい姿に生まれ変わろう<br>境界を超えた瞬間、世界が変わる", image: "./eki/49TakuKakaku.png" },

      { number: 50, name: "☲☴火風鼎（かふうてい）", emoji: "🔥🍃", keyword: "器・養う・新しい形", lines: [0,1,1,1,0,1], message: "素材を整え、新しい形に煮込む時。人にふるまえるものが、あなたの中で育っています。" , image: "./eki/50KaFutei.png"},

      { number: 51, name: "☳☳震為雷（しんいらい）", emoji: "⚡⚡", keyword: "衝撃・目覚め・驚き", lines: [1,0,0,1,0,0], message: "びっくりする出来事があっても、落ち着けば大丈夫。雷は目を覚ますために鳴ることもあります。", image: "./eki/51ShiniRai.png" },

      { number: 52, name: "☶☶艮為山（ごんいざん）", emoji: "⛰️⛰️", keyword: "止まる・静止・境界", lines: [0,0,1,0,0,1], message: "止まることで整う日。進まないのではなく、今は動かないことで自分を守れます。", image: "./eki/52GoniZan.png" },

      { number: 53, name: "☴☶風山漸（ふうざんぜん）", emoji: "🍃⛰️", keyword: "ゆっくり進む・段階・成長", lines: [0,0,1,0,1,1], message: "少しずつ進むのが正解。焦らず段階を踏めば、ちゃんと景色は変わっていきます。", image: "./eki/53FuZanzen.png" },

      { number: 54, name: "☳☱雷沢帰妹（らいたくきまい）", emoji: "⚡🫧", keyword: "不安定な関係・順序・焦り", lines: [1,1,0,1,0,0], message: "勢いで合わせすぎると疲れそう。順序や立場をよく見て、焦らず整えて。", image: "./eki/54RaiTakukimai.png" },

      { number: 55, name: "☳☲雷火豊（らいかほう）", emoji: "⚡🔥", keyword: "豊かさ・盛大・ピーク", lines: [1,0,1,1,0,0], message: "光が強く、賑やかな流れ。今ある豊かさを味わいつつ、ピークの後も見据えて。", image: "./eki/55RaiKaho.png" },

      { number: 56, name: "☲☶火山旅（かざんりょ）", emoji: "🔥⛰️", keyword: "旅・仮の場所・慎み", lines: [0,0,1,1,0,1], message: "新しい世界を慎重に旅しよう<br>慣れない場所では礼儀も大切", image: "./eki/56KaZanryo.png" },

      { number: 57, name: "☴☴巽為風（そんいふう）", emoji: "🍃🍃", keyword: "浸透・柔らかさ・伝わる", lines: [0,1,1,0,1,1], message: "やわらかく入っていく力があります。強く押すより、じわじわ伝える方が届きます。", image: "./eki/57SoniFu.png" },

      { number: 58, name: "☱☱兌為沢（だいたく）", emoji: "🫧🫧", keyword: "喜び・対話・楽しさ", lines: [1,1,0,1,1,0], message: "楽しい会話や小さな喜びにツキ。軽やかな言葉が、人との距離を近づけてくれます。", image: "./eki/58DaiTaku.png" },

      { number: 59, name: "☴☵風水渙（ふうすいかん）", emoji: "🍃💧", keyword: "散る・ほどける・解散", lines: [0,1,0,0,1,1], message: "固まっていたものがほどける時。執着をゆるめると、新しい流れが入りやすくなります。", image: "./eki/59FuSuikan.png" },

      { number: 60, name: "☵☱水沢節（すいたくせつ）", emoji: "💧🫧", keyword: "節度・区切り・ルール", lines: [1,1,0,0,1,0], message: "制限は敵ではなく味方になる日。時間、お金、気力にほどよい枠を作って。", image: "./eki/60SuiTakusetsu.png" },
      ...
      { number: 64, name: "☲☵火水未済（かすいびせい）", emoji: "🔥💧", keyword: "未完成・これから・最後の一歩", lines: [0,1,0,1,0,1], message: "まだ完成前。でも可能性は十分あります。焦らず、最後の一歩に必要な準備を整えて。" , image: "./eki/64KaSuibisei.png"}
    ];
